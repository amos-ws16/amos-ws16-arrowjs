...
function chatComparisonPlugin (chat, text, params) {
  ...
  let intervallChat = utils.deleteChatMessagesNotInTimeIntervall(chat, startTime, endTime)
  let finalTransChat = (user === '*' ? intervallChat : utils.deleteChatMessagesNotFromUser(intervallChat, user))
